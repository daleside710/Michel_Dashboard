...
namespace AdminApp.Controllers
{
    public class SeleccioneumaticoController : Controller
    {
        ...
        public IActionResult SelectForm()  // idsession and 3 select options updated
        {
            ...
            //
            return Redirect("seleccion-regalo");
        }
        ...
        public IActionResult Regalo()
        {
            ...
            if(int.Parse(llanta) == 16)
            {
                ViewBag.suffix_price = (int.Parse(neumatico)) * 10;
            }
            if (int.Parse(llanta) == 17)
            {
                ViewBag.suffix_price = (int.Parse(neumatico)) * 15;
            }
