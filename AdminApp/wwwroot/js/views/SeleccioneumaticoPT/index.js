...
$(document).ready(function () {
    ...
    $("#cboruedas").on('click', function () {
        ...
        $.ajax({
            beforeSend: function () {
                var html = "<li class='searching' style='margin: 0px 10px;cursor: initial;'>Procurando ...</li>";
...
function isCheck() {
    ...
    if (llanta_model != "Modelo dos pneus" && llanta != "Tamanho da jante" && neumatico != "Número de pneus comprados") {
